  ...
  return [
    {
      ...
      description: "Corpo inteiro, 3x semana, máquinas e peso corporal. Baseado em exercícios da biblioteca.",
      level: "Iniciante",
      days: 3,
      exercises: [
        { name: "Agachamento Livre", sets: 3, reps: "12", rest: "60s" },
        { name: "Supino Reto com Halteres", sets: 3, reps: "10", rest: "60s" },
        { name: "Puxada Frontal (Pulldown)", sets: 3, reps: "12", rest: "60s" },
    ...
    },
    {
      ...
      description: "Divisão clássica A B C para quem já treina há meses. Usa exercícios da biblioteca.",
      level: "Intermediário",
      days: 6,
      exercises: [
        { name: "Supino Inclinado com Halteres", sets: 4, reps: "8-10", rest: "90s" },
        { name: "Crucifixo com Halteres", sets: 3, reps: "12", rest: "60s" },
        { name: "Puxada Frontal (Pulldown)", sets: 4, reps: "8-10", rest: "90s" },
        { name: "Leg Press 45°", sets: 4, reps: "10", rest: "90s" },
        { name: "Rosca Direta com Barra", sets: 3, reps: "12", rest: "45s" },
      ],
    },
    {
      id: "tpl-casa",
      name: "Em Casa Sem Equipamento",
      description: "Zero impacto, só peso corporal. Ideal para traveling. Exercícios da biblioteca.",
      level: "Todos os níveis",
      days: 3,
      exercises: [
        { name: "Agachamento Livre", sets: 3, reps: "15", rest: "45s" },
        { name: "Flexão de Braço", sets: 3, reps: "10", rest: "45s" },
        { name: "Afundo com Halteres", sets: 3, reps: "12", rest: "45s" },
    ...
    },
    {
      id: "tpl-gluteo",
      name: "Glúteos Foco",
      description: "Ativação + carga, 3x semana, baixo impacto nas articulações. Baseado na biblioteca.",
      level: "Intermediário",
      days: 3,
      exercises: [
        { name: "Elevação Pélvica (Glute Bridge)", sets: 4, reps: "10-12", rest: "90s" },
        { name: "Abdução de quadril", sets: 4, reps: "15", rest: "60s" },
        { name: "Stiff com Barra", sets: 3, reps: "12", rest: "75s" },
        { name: "Cadeira flexora", sets: 3, reps: "12", rest: "60s" },
      ],
    },
  ];
}
